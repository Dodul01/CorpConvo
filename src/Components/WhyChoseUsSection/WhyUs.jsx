...
const WhyUs = () => {
  return (
    <div className=' my-10'>
      <h1 data-aos="zoom-in-right" className='text-3xl font-bold mx-5 mt-15 mb-5'>Why Chose Us?</h1>
      <div className='flex gap-4 lg:flex-row flex-col'>
        <div data-aos="fade-right" data-aos-duration="1000" className='border-2 p-4 rounded-lg m-4'>
        ...
        <div data-aos="zoom-in" data-aos-duration="1000" className='border-2 p-4 rounded-lg m-4'>
        ...
        <div data-aos="fade-up" data-aos-duration="1000" className='border-2 p-4 rounded-lg m-4'>
